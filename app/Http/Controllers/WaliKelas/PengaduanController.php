...
class PengaduanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('waliKelas.daftar-pengaduan', compact('pengaduan', 'kategoris'));
    }
    ...
    public function show($id)
    {
        ...
        $pengaduan = Pengaduan::with(['siswa', 'kategori', 'tanggapan'])
            ->whereHas('siswa', function($q) use ($kelasId) {
                $q->where('kelas_id', $kelasId);
            })
            ->findOrFail($id);

        return view('waliKelas.detail-pengaduan', compact('pengaduan'));
    }
