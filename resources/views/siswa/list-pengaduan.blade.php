...
<head>
    ...
    <title>Daftar Pengaduan Saya - SekolahCare</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('siswa.list-pengaduan') }}"><i class="bi bi-list-ul"></i> Riwayat Pengaduan</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="complaints-container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="mb-0">Daftar Pengaduan Saya</h4>
            </div>
            ...
            <!-- Filter Form -->
            <form action="{{ route('siswa.list-pengaduan') }}" method="GET" id="filterForm">
                <div class="collapse filter-collapse" id="filterCollapse">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="input-group search-mobile">
                                        <input type="text" class="form-control" name="search" value="{{ request('search') }}" placeholder="Cari berdasarkan judul atau isi pengaduan...">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 filter-actions-mobile">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('siswa.list-pengaduan') }}" class="btn btn-outline-secondary">
                ...
                @forelse($pengaduan as $p)
                    <div class="complaint-card">
                        ...
                        <div class="complaint-date mb-2">
                            <i class="bi bi-calendar"></i> {{ $p->created_at->format('d M Y') }}
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center complaint-footer-mobile">
                            ...
                            <a href="{{ route('siswa.detail-pengaduan', $p->id) }}" class="btn btn-primary btn-detail">Lihat Detail</a>
                        </div>
                    </div>
                @empty
                    <div class="text-center py-5 empty-state-mobile">
                        ...
                        <a href="{{ route('siswa.pengaduan') }}" class="btn btn-primary mt-3">
