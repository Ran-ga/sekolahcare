        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('siswa.profile') }}"><i class="bi bi-person-circle"></i> Profil</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <div class="profile-container">
            ...
            <div class="password-form">
                ...
                <form action="{{ route('siswa.profile.update-password') }}" method="POST" id="passwordForm">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{ route('siswa.profile') }}" class="btn btn-secondary ms-2">
