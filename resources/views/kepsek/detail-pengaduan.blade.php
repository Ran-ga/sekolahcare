    ...
    <div class="detail-container">
        <div class="complaint-card">
                ...
                <div class="response-section">
                    ...
                    <div class="response-form mt-4">
                        ...
                        @if($pengaduan->status != 'Selesai')
                            <form action="{{ route('kepsek.tanggapan.store', $pengaduan->id) }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        @elseif($pengaduan->status == 'Diproses')
                                            <a href="{{ route('kepsek.pengaduan.update-status', ['id' => $pengaduan->id, 'status' => 'Selesai']) }}" 
            ...
            <div class="text-center mt-4">
                <a href="{{ route('kepsek.daftar-pengaduan') }}" class="btn btn-secondary">
