        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('waliKelas.daftar-pengaduan') }}"><i class="bi bi-list-ul"></i> Daftar Pengaduan</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="complaints-container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="mb-0">Daftar Pengaduan Kelas Saya</h4>
            </div>

            <!-- Mobile Filter Toggle Button -->
            <button class="btn btn-outline-success mobile-filter-toggle" type="button" data-bs-toggle="collapse" data-bs-target="#filterCollapse">
                <i class="bi bi-funnel"></i> Filter & Pencarian
            </button>

            <!-- Filter Form -->
            <form action="{{ route('waliKelas.daftar-pengaduan') }}" method="GET" id="filterForm">
                <div class="collapse filter-collapse" id="filterCollapse">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 filter-actions-mobile">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('waliKelas.daftar-pengaduan') }}" class="btn btn-outline-secondary">
                ...
                @forelse($pengaduan as $p)
                    <div class="complaint-card">
                        ...
                        <div class="d-flex justify-content-between align-items-center complaint-footer-mobile">
                            ...
                            <a href="{{ route('waliKelas.detail-pengaduan', $p->id) }}" class="btn btn-primary btn-detail">
