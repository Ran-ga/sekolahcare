    ...
    <div class="detail-container">
        <div class="complaint-card">
                ...
                <div class="response-section">
                    ...
                    <div class="response-form mt-4">
                        ...
                        @if($pengaduan->status != 'Selesai')
                            <form action="{{ route('guruBk.tanggapan.store', $pengaduan->id) }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        @elseif($pengaduan->status == 'Diproses')
                                            <a href="{{ route('guruBk.pengaduan.update-status', ['id' => $pengaduan->id, 'status' => 'Selesai']) }}" 
                                        ...
                                        @elseif($pengaduan->status == 'Selesai')
                                            <a href="{{ route('guruBk.pengaduan.update-status', ['id' => $pengaduan->id, 'status' => 'Diproses']) }}" 
                                               class="btn btn-primary"
                                               onclick="return confirm('Apakah Anda yakin ingin mengubah status menjadi Diproses?')">
                                                <i class="bi bi-arrow-counterclockwise"></i> Ubah Status Menjadi Diproses
                                            </a>
                                        @endif
                                    </div>
            ...
            <div class="text-center mt-4">
                <a href="{{ route('guruBk.daftar-pengaduan') }}" class="btn btn-secondary">
