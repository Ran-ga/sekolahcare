...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('guruBk.daftar-pengaduan') }}"><i class="bi bi-list-ul"></i> Daftar Pengaduan</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="complaints-container">
            ...
            <!-- Filter Form -->
            <form action="{{ route('guruBk.daftar-pengaduan') }}" method="GET" id="filterForm">
                <div class="collapse filter-collapse" id="filterCollapse">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 filter-actions-mobile">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('guruBk.daftar-pengaduan') }}" class="btn btn-outline-secondary">
                ...
                @forelse($pengaduan as $p)
                    <div class="complaint-card">
                        ...
                        <div class="d-flex justify-content-between align-items-center complaint-footer-mobile">
                            ...
                            <a href="{{ route('guruBk.detail-pengaduan', $p->id) }}" class="btn btn-primary btn-detail">Lihat Detail</a>
                        </div>
                    </div>
                @empty
